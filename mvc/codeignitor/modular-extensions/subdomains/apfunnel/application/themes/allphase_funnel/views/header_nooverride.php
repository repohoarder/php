...
<html lang="en-us" dir="ltr">
	<head>
		...
		<script src="/resources/brainhost/js/modernizr-2.6.2.min.js"></script>
		...
		#accordion ul.hosting-package li strong {bottom: -24px;left: 0;}
			h1 {color: #1D4D87;text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.5);text-align: center;padding: 15px 20px;float: left;width: 100%;margin:0;font-weight: normal;font-size: 22px;border: 1px solid #8FB9D0;padding: 15px 20px;background:#D1F1F8 url(../img/bg-steps.png) 0 0 repeat-y;}
