...
class Breakdown_percent extends MX_Controller {
	...
	function index($brand = 'all_brands')
	{
		...
		$response = $this->platform->post('crm/reports/breakdown/percent/'.$brand, $params);
		...
		$data['title']               = 'Product Breakdown Percent';
