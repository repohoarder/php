...
class Rev_refunds extends MX_Controller {
	...
	function index($brand = 'brainhost')
	{
		...
		// PLATFORM REQUEST
			...
			// grab revenue
			$revenue	= $this->platform->post('crm/reports/refund/rev_refund_revenues', $params);
			...
			// grab refunds
			$refunds	= $this->platform->post('crm/reports/refund/rev_refund_refunds', $params);
			...
			// grab refunds
			$chargebacks	= $this->platform->post('crm/reports/refund/rev_refund_chargebacks', $params);
