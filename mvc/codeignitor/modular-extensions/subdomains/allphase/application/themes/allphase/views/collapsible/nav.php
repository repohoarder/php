	...
	<ul id="nav-main">
		...
		<li class="nav-manage <?php if ($segments[1] == 'manage') echo 'active'; ?>">
			...
			<ul>
				...
				<li <?php if ($segments[1] == 'manage' AND $segments[2] == 'thankyou') echo 'class="active"'; ?> ><a href="/manage/thankyou" title="Manage Thamk You Page">Thank You Page</a></li>
		...
		<li class="nav-costs <?php if ($segments[1] == 'operating') echo 'active'; ?>"><a href="/operating/breakdown" title="Operating Costs">Operating Costs</a></li>
