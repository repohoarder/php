...
// show head
echo $this->template->load_view('special-offer/head.php'); 


// make sure we need to show layout - if so 
if ($show_layout) echo $this->template->load_view('special-offer/header.php'); 
...
<div id="t-main" role="main">
	<div class="wrap">
		...
		<nav id="col-l"<?php echo ($nav_collapsed) ? ' class="condense" ': ''; ?>>
			<?php echo $this->template->load_view('special-offer/nav.php'); ?>
		</nav>
	</div>
</div>
...
if ($show_layout) echo $this->template->load_view('special-offer/footer.php'); 