			...
			<table class="table table-striped table-bordered table-condensed dTableR uafix" id="service_table" aria-describedby="service_table_info">
				<thead>
					<tr class="nosort" role="row">
						...
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="service_table" rowspan="1" colspan="1">Funnel Type</th>
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all">
					...
					?>
						<tr id="record_<?php echo $value['id']; ?>" class="<?php echo $class; ?>">
							...
							<td><?php echo $value['funnel_type']; ?></td>
							...
							<?php if ($partner_id): ?><td><a href="<?php echo $this->config->item('subdir'); ?>/partner/pricings/<?php echo $value['partner_id']; ?>/<?php echo $value['funnel_id']; ?>">Pricings</a></td><?php endif; ?>
						</tr>
