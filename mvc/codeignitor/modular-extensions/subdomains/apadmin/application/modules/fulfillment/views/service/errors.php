...
<div class="row-fluid">
	...
	<div class="span12">
-->
		<h3 class="heading">Fulfillment Errors</h3>
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all">
					...
					?>
						...
						<tr id="record_<?php echo $value['id']; ?>" class="<?php echo $class; ?>">
							...
							<td><a href="http://my.hostingaccountsetup.com/admin/clientmgr/client_service_details.php?packid=<?php echo $value['_id']; ?>" target="_blank"><?php echo $value['_id']; ?></a></td>
							<td title="<?php echo $value['error']; ?>"><?php echo $value['error']; ?></td>
							<td><?php echo date('m/d/Y',strtotime($value['error_inserted'])); ?></td>
							<td>
								<a href="<?php echo $this->config->item('subdir'); ?>/fulfillment/service/dismiss/<?php echo $value['id']; ?>" onclick="return confirm_dismiss();">
									<img src="<?php echo $this->config->item('subdir'); ?>/resources/apadmin/img/gCons/edit.png" title="Dismiss the Error">
								</a>
								&nbsp;&nbsp;
								<a href="<?php echo $this->config->item('subdir'); ?>/fulfillment/service/close/<?php echo $value['id']; ?>" onclick="return confirm_close();">
