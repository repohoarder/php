...
<html lang="en-us" dir="ltr">
	<head>
		...
		<!--[if IE]><![endif]-->
		<link rel="stylesheet" href="/resources/special_offer/css/style.css" />		

		<!-- Load jQuery & jQuery UI from Google CDN -->
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
		<script>window.jQuery || document.write('<script type="text/javascript" src="/resources/special_offer/js/jquery-1.9.1.min.js"><\/script>')</script>

		<!-- Modernizr to make older browsers behave -->
		<script src="/resources/special_offer/js/modernizr-2.6.2.min.js"></script>
		...
		<?php endif; ?>
		<!-- Custom jQuery -->
		<script src="/resources/special_offer/js/script.js"></script>
	</head>
