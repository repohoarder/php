...
<div class="box">
    <p>
        Enter your billing information below to sign up for website hosting. <br/>
        If you do not complete your order within the <strong>next 10 minutes</strong>, your website will be released. 
    </p>
</div>
<div class="billing-wrap">
    ...
    <?php echo form_open('',array('id' => 'form-billing'),array('billing_form' => 1,'action_id' => 91)); ?>
        <ol id="accordion">
                        ...
                        if (isset($upsell_prices) && count($upsell_prices)):
                            ...
                            foreach ($upsell_prices as $key => $term_array): ?>
                                ...
                                <li class="upsell_check">
                                    ...
                                    if ($affiliate_id == 101513) $checked = '';
