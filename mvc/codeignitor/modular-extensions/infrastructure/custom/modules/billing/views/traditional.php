<h1><?php echo $this->lang->line('billing_v1_congrats_traditional'); ?> <em><?php echo isset($fields['core_domain']) ? $fields['core_domain'] : '';?>!</em></h1>
<br style="clear:both;" />
<!--<div class="box">
...
<div class="billing-wrap">
    <!--
    <img src="/resources/modules/billing/assets/v1/img/img-satisfaction-guaranteed.jpg" alt="100% Satisfaction Guaranteed" />
    <img src="/resources/modules/billing/assets/v1/img/img-trust.jpg" alt="250,000+ Companies Trust Us With Their Website" />
	-->
    <?php echo form_open('',array('id' => 'form-billing'),array('billing_form' => 1,'action_id' => 81)); ?>
        <ol id="accordion">
            <li class="one accordion-level">
                
                <h2><?php echo $this->lang->line('billing_v1_customize_hosting_package'); ?></h2>
                <div>
                    ...
                    <ul class="col-l">
                        ...
                        <li>
                            ...
                            (<?php echo isset($fields['core_domain']) ? $fields['core_domain'] : '';?>) ($<span id="annual_price"><?php echo $core_prices['annual']['price'] ;?></span>)
                        </li>
                        ...
                        if (isset($upsell_prices) && count($upsell_prices)):
                            ...
                            foreach ($upsell_prices as $key => $term_array): ?>
                                ...
                                <li class="upsell_check">
                                    ...
                                    <?php
                                    $checked = ( ! $fields['bill_upsells'][$key] && $this->input->post('billing_form')) ? '' : '';
                                    ...
                                    echo $billing_upsells[$key];?> ($<?php echo $term_array['annual']['price'];?>/year)
