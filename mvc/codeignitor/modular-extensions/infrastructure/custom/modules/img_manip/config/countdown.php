...
$config['countdown_template']        = CUSTOM_PATH.'modules/img_manip/assets/img/countdown_minimal.png';

// countdown cache folder location
$config['countdown_folder']          = CUSTOM_PATH.'modules/img_manip/assets/img/countdowns';

// countdown font settings
$config['countdown_font_face']       = CUSTOM_PATH.'modules/img_manip/assets/fonts/arial.ttf';
