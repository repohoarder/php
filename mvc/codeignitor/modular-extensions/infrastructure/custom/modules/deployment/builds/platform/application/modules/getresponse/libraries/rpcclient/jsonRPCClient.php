...
*/
    public function __call($method, $params)
    {
        ...
        $response = $this->getResponseRPC($request);
		...
		// modified this on 5/2/13 to suppress fatal error crash
        $error = $this->checkForErrors($validateParams);
...
* @return string
*/
    protected function & getResponseRPC(& $request)
    {
